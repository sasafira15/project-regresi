...
<div class="container-fluid">
    ...
    <div class="row">
        <!-- Kolom Kiri: Daftar Mesin, Upload, & Metrics -->
        <div class="col-lg-4">
            <!-- Card Daftar Mesin -->
            ...
            <!-- START: CARD BARU UNTUK RIWAYAT UPLOAD -->
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-history me-2"></i>Riwayat Upload Data
                    </h6>
                </div>
                <div class="card-body">
                    <?php if (!empty($uploads)): ?>
                        <div class="table-responsive" style="max-height: 350px; overflow-y: auto;">
                            <table class="table table-sm table-hover mb-0">
                                <thead class="text-primary sticky-top bg-white shadow-sm" style="top: -10px;">
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="align-middle">#<?= esc($upload['id']) ?></td>
                                        <td class="align-middle" style="font-size: 0.9rem;">
                                            <?= esc($upload['original_file_name']) ?><br>
                                            <small class="text-muted">
                                        ...
                                        <td class="text-center align-middle">
                                            <?php
                                                // Gunakan status dari tb_uploads (misalnya 'pending')
                                            ...
                                            ?>
                                            <span class="badge <?= $class ?>" style="padding: 0.5em 0.8em; border-radius: 1rem; font-size: 0.75rem;">
                                                <i class="<?= $icon ?> me-1"></i> 
                                                <?= ucfirst(esc($status)) ?>
                                            </span>
                                        </td>
            ...
            <!-- END: CARD BARU UNTUK RIWAYAT UPLOAD -->
